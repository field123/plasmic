...
After creating this guide, you can safely delete these files as they contain sensitive information:
- `/platform/wab/create-user-david.ts` (contains hardcoded password)
- `/platform/wab/create-user-rezwan.ts` (contains hardcoded password)
- `/platform/wab/create-user-rezwan.sql` (contains example password hash)

Keep the guide as the authoritative reference for user creation.